...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Text = L"Уехать жить в город: 3000000 рублей";
...
#pragma endregion
	...
	private: System::Void GameForm_Activated(System::Object^ sender, System::EventArgs^ e) {
		...
		label3->Text = "Деньги: " + Convert::ToString(this->shopform->balancemoneysecond) + " рублей";
		...
		else if (this->shopform->bucket == 6)
		{
			...
			backpack = 2147483646;
			this->label2->Text = "Молоко: " + Convert::ToString(balancemilk) + " литров";
		}
		...
		if (balancemilk > 0)
		{
			if (randomsell == 1)
			{
				...
				else
				{
					...
					this->label3->Text = "Деньги: " + Convert::ToString(this->shopform->balancemoneysecond) + " рублей";
			}
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	shopform->label1->Text = "Деньги: " + Convert::ToString(this->shopform->balancemoneysecond) + " рублей";
	shopform->Show();
	this->Hide();
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	if (this->shopform->balancemoneysecond >= 3000000)
	{
		...
		this->label3->Text = "Деньги: " + Convert::ToString(this->shopform->balancemoneysecond) + " рублей";
		MessageBox::Show("Вы звоните вашему риелтору.\nВы готовы купить квартиру и покупаете её.\nВы приезжаете в город и живёте долго и счастливо!\nСпасибо за игру <3!", "MilkClicker", MessageBoxButtons::OK, MessageBoxIcon::Information);
		Form^ menuform = this->Owner;
		menuform->Close();
	}
	else
	{
		MessageBox::Show("У вас недостаточно средств на покупку квартиры!", "MilkClicker", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}
}
};
}
